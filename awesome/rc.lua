...
globalkeys = mytable.join(
	...
	end, { description = "music", group = "applications" }),

	awful.key({ modkey }, "d", function()
		awful.util.spawn("Discord")
	end, { description = "discord", group = "applications" }),
	...
	end, { description = "Make screenshot to ~/Pictures/screenshots/", group = "applications" }),
   ...
   -- j         os.execute(string.format("rofi -show %s -theme %s",
     --        'run', 'dmenu'))
     --   end,
